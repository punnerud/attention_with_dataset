...
![Attention Map Example](https://punnerud.github.io/attention_with_dataset/example1.png)
*The model's attention heatmaps showing where it detects different object classes*

### SAM Segmentation with Attention Guidance
![SAM Segmentation Example](https://punnerud.github.io/attention_with_dataset/example2.png)
